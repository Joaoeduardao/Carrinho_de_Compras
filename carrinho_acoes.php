 ...
 */
    if(isset($_GET['acao_carrinho'])) {
        ...
        switch($GET['acao_carrinho']) {
            ...
            case 'limpar'://naURLdonavegador:carrinho_acoes.phpacao_carrinho=limpar
            ...
            case 'add': // adiciona um produto ao carrinho.
                ...
                $_SESSION['carrinho'][] = $dados_produtos_a_ser_add; // Adicionando os dados do produto
            break;

            case 'remover':
                $item carrinho = $_GET['item']; // pegando qual item o usuário quer remover.
            ...
            case 'atualiza-qnt':
                $item_carrinho = $GET['item']; // pegando qual item o usuário quer atualizar a qnt.
                ...
                if(isset($_SESSION['carrinho'][$item_carrinho])) { // verificando se o item existe...
                    ...
                    $_SESSION['carrinho'][$item_carrinho]['quantidade'] = $qnt; // definindo novamente a quantiudade.
